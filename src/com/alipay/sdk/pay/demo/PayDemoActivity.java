...
public class PayDemoActivity extends BaseActivity {
	...
	private String notifyUrl = NetUrl.TEST_HOST + "pay/alipay/notify";
	...
	private void orderJson() {
		// json="{'orderid':'1433497680701567101559104','ordertitle':'东岳驾校'','ordercon':'驾校报名收费','orderprice','0.01'}";
		// json=
		// "{'ordercon':'http://www.baidu.com','orderprice':'0.01','ordertitle':'sdgfsdf','orderid':'151655'}";
