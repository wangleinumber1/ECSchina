...
public class GoodDetailCityPoputils implements OnClickListener {
	public GoodDetailCityPoputils(Context context, BaseActivity mActivity,
	...
	public void citypoplist(View leftImage,Activity activity) {
		i = 0;
		...
		initSpinner1();
		((BaseActivity) activity).setPopBackgroud((float) 0.7);
	...
	private class PopOnitemclicListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			if (i == 0) {
				...
				if (popupWindow != null) {
					popupWindow.dismiss();
					((BaseActivity) activity).setPopBackgroud((float) 1);
					if (button != null) {
