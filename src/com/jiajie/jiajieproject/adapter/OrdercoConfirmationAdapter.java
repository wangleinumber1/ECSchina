 ...
 * 下午2:19:53 修改备注：
 */
public class OrdercoConfirmationAdapter extends BaseAdapter {
	...
	public OrdercoConfirmationAdapter(Activity activity, ImageLoad imageLoad) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		vh.orderconfirmationitem_layouttext1.setText(list.get(position).productName);
		vh.numbercount.setText(list.get(position).qty);
		return convertView;
	}
