 ...
 * 上午10:27:24 修改备注：
 */
public class NewProjectMessageAdapter2 extends BaseAdapter implements
		OnClickListener {
	private ArrayList<newprojectmodel> list = new ArrayList<newprojectmodel>();
	...
	public NewProjectMessageAdapter2(Activity activity) {
	...
	public ArrayList<newprojectmodel> getdata() {
		return list;
	}

	public void setdata(ArrayList<newprojectmodel> list) {
		this.list = list;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		vh.newprojectmessageTitle.setText(list.get(position).title);
		vh.newprojectmessagetime.setText(list.get(position).date);
