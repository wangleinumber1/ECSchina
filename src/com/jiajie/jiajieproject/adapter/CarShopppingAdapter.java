...
public class CarShopppingAdapter extends BaseAdapter implements OnCheckedChangeListener
,OnClickAddAndSubListener {
...
//		initDate(list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			vh.imgeView1 = (CheckBox) convertView
...
//			vh.edt = (EditText) convertView.findViewById(R.id.edt);
			vh.my_add_sub=(MyAddAndSubView) convertView.findViewById(R.id.my_add_sub);
...
//		vh.catshoppingitem_layouttext1.setText(produceClass.productName);
		return convertView;
	}
	...
	class ViewHolder {
		...
		TextView pricetext, catshoppingitem_layouttext1;
		EditText edt;
