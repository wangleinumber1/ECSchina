 ...
 */
public class ProjectRealeseActivity extends TabActivity implements
		OnClickListener {
	public String TAB_LIST[] = { "项目信息", "定向发送" };

	public Class mHomeTabClassArray[] = { ProjectMessageActivity.class,
			DirectiveSendingActivity.class };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.projectrealse_layout);
		initView();
